...
export interface VaultInterface extends utils.Interface {
  functions: {
    ...
    "claimUpgrade(uint256,uint256)": FunctionFragment;
    ...
    "lastUpdatedBalance(address)": FunctionFragment;
    "lastUpdatedScores(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "balanceOfForum",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "claimUpgrade",
  ...
  encodeFunctionData(
    functionFragment: "initialBalanceOfBadges",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "isForum",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "lastUpdatedBalance",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "lastUpdatedScores",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "nftURIs",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setBadgesAddr",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
